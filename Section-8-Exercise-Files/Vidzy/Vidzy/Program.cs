...
namespace Vidzy
{
    class Program
    {
        ...
        private static void AddVideoToTagIfRequired(VidzyContext context, Tag tag, Video video)
        {
        ...
        private static void Step3()
        {
            ...
            using (var context = new VidzyContext())
            {
                if (context.Videos.Count(v => v.Name.Equals(godFatherVideoName)) == 1)
                {
                    ...
                    AddVideoToTagIfRequired(context, tag1, godFatherVideo);
                    AddVideoToTagIfRequired(context, tag2, godFatherVideo);
                    AddVideoToTagIfRequired(context, tag3, godFatherVideo);
        ...
        private static void Step6()
        {
            ...
            using (var context = new VidzyContext())
            {
                ...
                {
                    var genreToBeDeleted = context.Genres.Where(v => v.Name.Equals(genreType)).Single();
